...
module LDA(D: Oml.Classification.Input_interfaces.Continuous_encoded_data) : sig
...
module QDA(D: Oml.Classification.Input_interfaces.Continuous_encoded_data) : sig
  include Oml.Classification.Classifier_interfaces.Generative
      with type feature = D.feature
       and type class_ = D.class_
       and type feature_probability = float
